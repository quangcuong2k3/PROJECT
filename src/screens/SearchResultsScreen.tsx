...
const SearchResultsScreen: React.FC<SearchResultsScreenProps> = ({
  ...
  // Debug modal states
  useEffect(() => {
    console.log('🔍 SearchResultsScreen: Modal states changed:', {
      showImageSearch,
      showVoiceSearch,
    });
  ...
  useFocusEffect(
    React.useCallback(() => {
      const handleAutoOpenModals = async () => {
        console.log('🔍 SearchResultsScreen: Screen focused, checking auto-open params:', {
          openVoiceSearch: route.params?.openVoiceSearch,
          openImageSearch: route.params?.openImageSearch,
        });
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <View style={styles.searchContainer}>
          ...
          <TouchableOpacity
            onPress={() => {
              console.log('🎤 Manual voice search button pressed');
              setShowVoiceSearch(true);
            }}
          ...
          <TouchableOpacity
            onPress={() => {
              console.log('📷 Manual image search button pressed');
              setShowImageSearch(true);
            }}
